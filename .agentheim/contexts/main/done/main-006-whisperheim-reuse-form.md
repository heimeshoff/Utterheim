...
Decision recorded: **copy-and-modify** WhisperHeim infrastructure into mockingbird's tree for v1, with provenance headers and CHANGELOG entries; revisit shared-library extraction post-v1. Unblocks `main-009` (actual file copy).

- ADR: `.agenthoff/knowledge/decisions/0006-whisperheim-reuse-copy-and-modify.md`
