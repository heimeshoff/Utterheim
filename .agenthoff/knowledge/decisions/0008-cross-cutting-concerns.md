...
- `%LOCALAPPDATA%\Mockingbird\` becomes the durable home for logs, models, runtime, and bootstrap state — uninstall implication noted for v1.5.
...
- **Modal error dialogs instead of tray toasts** — interrupts the terminal-focused workflow Mockingbird is built around; tray toasts respect the user's attention.
...
- ADR 0006 (WhisperHeim reuse — copy-and-modify): `.agenthoff/knowledge/decisions/0006-whisperheim-reuse-copy-and-modify.md`
