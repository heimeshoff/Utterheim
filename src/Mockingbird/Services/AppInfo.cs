...
/// Extracted in main-030 so <see cref="Mockingbird.Views.Controls.BrandHeroControl"/>
...
public static class AppInfo
{
    ...
    /// <summary>
    /// Ko-fi support page Marco maintains for both Mockingbird and WhisperHeim
    ...
    /// <summary>
    /// Mockingbird's public GitHub repository — distinct from WhisperHeim's so
    /// the About page links to the right project. Surfaced by the About page's
    /// "View on GitHub" link (main-032).
    /// </summary>
    public const string GithubUrl = "https://github.com/heimeshoff/mockingbird";
