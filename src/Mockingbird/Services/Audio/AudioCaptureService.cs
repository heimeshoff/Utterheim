// Adapted from WhisperHeim/src/WhisperHeim/Services/Audio/AudioCaptureService.cs @ 911bff0
using NAudio.Wave;

namespace Mockingbird.Services.Audio;
...
/// 16 kHz is fine for cloning since pocket-tts resamples internally; no need
/// to bump the rate (per main-025 service-copies note).
/// </summary>
public sealed class AudioCaptureService : IAudioCaptureService
{
    /// <summary>16kHz sample rate.</summary>
