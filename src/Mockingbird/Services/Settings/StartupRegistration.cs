...
/// that controls "Launch at startup" for mockingbird (main-016).
///
...
public sealed class StartupRegistration
{
    ...
    /// </summary>
    public const string ValueName = "Mockingbird";
    ...
    /// <summary>
    /// True when the <c>Mockingbird</c> value exists under
    ...
    public static string CurrentExecutablePath
    {
        get
        {
            // Process.MainModule.FileName returns the host .exe path (mockingbird.exe),
            ...
            return Path.Combine(AppContext.BaseDirectory, "mockingbird.exe");
        }
    }
