# Utterheim-owned Python sidecar wrapper around pocket-tts.
#
# Per ADR 0015 (.agentheim/knowledge/decisions/0015-utterheim-sidecar-wrapper.md)
...
#
# Entry point: `python -m utterheim_sidecar serve --host 127.0.0.1 --port 0`
