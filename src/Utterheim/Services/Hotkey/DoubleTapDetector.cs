// Utterheim-specific: low-level keyboard hook listening for a double-tap of RCtrl.
...
namespace Utterheim.Services.Hotkey;
...
/// the gesture works even when utterheim's window is not focused.
/// </summary>
